...
DATABASES = {
    'default': {
        ...
        # <----------------- 5 Sep 2022 ------------------->
        'NAME': os.path.join(os.path.dirname(BASE_DIR), 'db', 'db.sqlite3'),
...
# <----------------- 5 Sep 2022 ------------------->
MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), 'db', 'media_root')
# --------------------------------------------------
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            # <----------------- 5 Sep 2022 ------------------->
            'filename': os.path.join(os.path.dirname(BASE_DIR), 'db', 'debug.log'),
            # --------------------------------------------------
