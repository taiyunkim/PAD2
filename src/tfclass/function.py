...
DISTAL_DISTRIBUTION = pickle.load(open(os.path.join(settings.MEDIA_ROOT, 'background_distribution', 'distal_dist.pickle'), 'rb'), encoding = 'latin1')
PROXIMAL_DISTRIBUTION = pickle.load(open(os.path.join(settings.MEDIA_ROOT, 'background_distribution', 'proximal_dist.pickle'), 'rb'), encoding = 'latin1')
